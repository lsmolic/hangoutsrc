...
then
	echo "Which instance of the Secure Site would you like to deploy to? (hangoutqa,hangoutqa2):"
	read instance
else
	instance=$webserverInstance
fi

mkdir /cygdrive/c/snapshots/$1/configcompare/qa/net.$instance.secure 2> /dev/null || true
