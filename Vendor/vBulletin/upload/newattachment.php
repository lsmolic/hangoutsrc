...
if (strtolower($_SERVER['HTTP_USER_AGENT']) == 'shockwave flash' AND $_SERVER['REQUEST_METHOD'] == 'POST' AND $_POST['ajax'] == 1 AND $_POST['do'] == 'manageattach')
{
...
while ($attach = $db->fetch_array($currentattaches))
{
	...
	$assetinfo = array(
		...
		'hasthumbnail'       => $attach['hasthumbnail'],
		'userid'             => $attach['fuserid'],
		...
		'thumbnail_width'    => $attach['thumbnail_width'],
		'thumbnail_height'   => $attach['thumbnail_height'],
		'thumbnail_dateline' => $attach['thumbnail_dateline'],
		'filesize_formatted' => vb_number_format($attach['filesize'], 1, true),
	);
