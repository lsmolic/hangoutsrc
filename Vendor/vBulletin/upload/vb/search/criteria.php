...
*/
	...
	public function add_forumid_filter($forumids, $include_children)
	{
		...
		if ($forumids)
		{
			...
			$forum_string = vB_Search_Searchtools::getDisplayString(
				'forum', $vbphrase['forum'], 'title', 'forumid', $forumids,
				vB_Search_Core::OP_EQ, false);
			
			$this->add_display_strings('forum', $forum_string .
	...
	public function add_excludeforumid_filter($forumids)
	{
		...
		$this->add_display_strings('exclude_forum', vB_Search_Searchtools::getDisplayString(
			'forum', $vbphrase['forum'], 'title', 'forumid', $forumids,
