...
if ($_POST['do'] == 'postreply')
{
	...
	else if ($newpost['preview'])
	{
		...
		if ($vbulletin->GPC_exists['return_url'] AND strlen($vbulletin->GPC['return_url']))
		{
			exec_header_redirect($vbulletin->GPC['return_url']);
		}
...
if ($_REQUEST['do'] == 'newreply')
{
	...
	$templater = vB_Template::create('newreply');
		...
		$templater->register('return_url', $vbulletin->GPC['return_url']);
