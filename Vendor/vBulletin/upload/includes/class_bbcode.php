...
*
* @package 		vBulletin
* @version		$Revision: 33660 $
* @date 		$Date: 2009-11-18 16:30:51 -0600 (Wed, 18 Nov 2009) $
*
*/
					...
					switch($attachment['extension'])
					{
						...
						case 'pdf':
							...
							if (($settings OR ($this->registry->options['attachthumbs'] AND $attachment['hasthumbnail'])) AND $this->registry->userinfo['showimages'])
							{
								...
								else if (!$settings AND $align != 'config')
								{
							...
							else if ($this->displayimage AND $this->registry->userinfo['showimages'] AND ($forceimage OR $this->registry->options['viewattachedimages']) AND !in_array($attachment['extension'], array('tiff', 'tif', 'psd', 'pdf')))
