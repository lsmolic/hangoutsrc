...
if ($_POST['do'] == 'quickedit')
{
	...
	else
	{
		...
		$xml->add_group('quickedit');
			...
			add_ajax_attachment_xml($xml, $contenttypeid, $posthash, $poststarttime, array('t' => $threadinfo['threadid']));
		$xml->close_group();
		$xml->print_xml();
	}
}
	...
	or $_REQUEST['do'] == 'list_allcategory' or $_REQUEST['do'] == 'find_leaves')
{
	...
	require_once('./admincp/cms_content_admin.php');
...
if ($_REQUEST['do'] == 'perms_section' or $_REQUEST['do'] == 'del_perms')
{
	...
	require_once('./admincp/cms_permissions.php');
	//and that page will do all the work.
}
