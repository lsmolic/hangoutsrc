...
function verify_vb3_enviroment()
{
	...
	// php version check
	if (!function_exists('version_compare') OR version_compare(PHP_VERSION, '5.1.2', '<'))
	{
...
function print_next_step()
{
	...
	<table cellpadding="4" cellspacing="0" border="0" width="100%" class="navbody" style="padding:4px; border:outset 2px;">
	<tr align="center">
		<td><b><?php echo $upgradecore_phrases['click_button_to_proceed']; ?></b><br />vBulletin &copy; <?php echo date('Y'); ?> vBulletin Solutions, Inc. All rights reserved.</td>
...
*
* @package	vBulletin
* @version	$Revision: 33410 $
* @date		$Date: 2009-11-11 19:11:40 -0600 (Wed, 11 Nov 2009) $
*/
