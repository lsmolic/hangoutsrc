...
namespace Affirma.ThreeSharp
{
    ...
    public interface IThreeSharp
    {
        ...
        /// <summary>
        /// Gets the RequestPaymentConfiguration 
        /// </summary>
        PaymentGetResponse PaymentGet(PaymentGetRequest request);

        /// <summary>
        /// Changes the RequestPaymentConfiguration 
        /// </summary>
        PaymentChangeResponse PaymentChange(PaymentChangeRequest request);
        ...
        /// </summary>
        TransferInfo[] GetTransferInfos();

        /// <summary>
        /// Returns statistics about a single data transfer operation
        /// </summary>
        TransferInfo GetTransferInfo(String id);
