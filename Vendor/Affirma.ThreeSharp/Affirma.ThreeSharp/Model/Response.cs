...
namespace Affirma.ThreeSharp.Model
{
    ...
    public class Response : Transfer
    {
        ...
        /// <summary>
        /// Streams the response object's datastream into a byte array
        /// </summary>
        ...
        /// <summary>
        /// Streams the response object's datastream into a string
        /// </summary>
        ...
        /// <summary>
        /// Streams the response object's datastream into an XmlDocument
        /// </summary>
        ...
        /// <summary>
        /// Streams the response object's datastream to a file
        /// </summary>
        ...
        /// <summary>
        /// Decrypts the stream using a DESCryptoServiceProvider
        /// </summary>
        ...
        /// <summary>
        /// Decrypts the stream using any SymmetricAlgorithm
        /// </summary>
        ...
        private void TransferStream(Stream responseStream, Stream outputStream)
        {
            ...
            while (true)
            {
                ...
                this.TransferInfo.BytesTransferred += bytesRead;
            }
            this.BytesTotal = this.TransferInfo.BytesTransferred; 
            this.TransferInfo.BytesTotal = this.TransferInfo.BytesTransferred;
        }
