...
Hangout.config = 
{
	...
	metrics_funnel_id : "ho_onramp_2",
	metrics_funnel_step_names: [ "",
				     "started",
			       	     "selected_avatar",
				     "clicked_save_look",
				     "loaded_unity_install_prompt",
				     "completed_unity_install"
			       	   ],

	web_entry_point : "FashionMinigame",

	fb_canvas_height : "2000px",
...
if (MixpanelLib && (typeof MixpanelLib === "function"))
{
	...
	Hangout.metrics.track = function (eventName, extraProperties, callback)
		...
		props["inviter"] = Hangout.config.inviter_id;
