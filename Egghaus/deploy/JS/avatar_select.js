...
$.cookie('hangout_campaign', $.query.get('campaign'), { expires : 2 });
Hangout.config.campaign_id = $.query.get('campaign');
...
var shouldShowNew = Hangout.util.abtest();
//alert(shouldShowNew);
