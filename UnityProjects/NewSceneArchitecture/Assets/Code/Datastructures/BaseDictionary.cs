 ...
 *	 BaseDictionary.cs	
 *
 *	 Author: Nick Guerrera, http://blogs.msdn.com/nicholg/archive/2006/06/04/616787.aspx
 *	 Date: 06/10/2009
 *	 
 *	 --------------------------------------------------------  *
 */
...
//Doesn't work in Mono: [DebuggerTypeProxy(PREFIX + "DictionaryDebugView`2" + SUFFIX)]
public abstract class BaseDictionary<TKey, TValue> : IDictionary<TKey, TValue> {
	//Doesn't work in Mono: private const string PREFIX = "System.Collections.Generic.Mscorlib_";
	//Doesn't work in Mono: private const string SUFFIX = ",mscorlib,Version=2.0.0.0,Culture=neutral,PublicKeyToken=b77a5c561934e089";
	...
	[DebuggerDisplay("Count = {Count}")]
	//Doesn't work in Mono: [DebuggerTypeProxy(PREFIX + "DictionaryKeyCollectionDebugView`2" + SUFFIX)]
	...
	[DebuggerDisplay("Count = {Count}")]
	//Doesn't work in Mono: [DebuggerTypeProxy(PREFIX + "DictionaryValueCollectionDebugView`2" + SUFFIX)]
