...
public class MissingComponentException : System.SystemException {
	// Mock data:
	...
	public MissingComponentException( System.String message ){
		//Mock Data:
			m_functionCallCounts = new Dictionary<string, int>();
	...
	public MissingComponentException( System.String message, System.Exception innerException ){
		//Mock Data:
			m_functionCallCounts = new Dictionary<string, int>();
