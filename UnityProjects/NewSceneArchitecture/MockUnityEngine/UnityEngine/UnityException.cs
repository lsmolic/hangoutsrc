...
public class UnityException : System.SystemException {
	// Mock data:
	...
	public UnityException( System.String message ){
		//Mock Data:
			m_functionCallCounts = new Dictionary<string, int>();
	...
	public UnityException( System.String message, System.Exception innerException ){
		//Mock Data:
			m_functionCallCounts = new Dictionary<string, int>();
